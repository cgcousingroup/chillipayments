...
TOKEN = "7677916556:AAFp5LeSAWC6ECXjfz-R_mXPy7HGyUSNPSY"
...
produtos = [
    (
        ...
        "https://app.pushinpay.com.br/service/pay/9F5BF54F-87D2-4E92-9E3E-AB0A390BE89A",
        "https://app.pushinpay.com.br/service/pay/9F5BF54F-87D2-4E92-9E3E-AB0A390BE89A",
    ...
    (
        "🔥 VIP Vazados 🔥",
        "R$19,90",
        "https://app.pushinpay.com.br/service/pay/9f5e0e1c-4ea1-439d-8daf-5fdc8c1dee80",
        "https://app.pushinpay.com.br/service/pay/9F5BF54F-87D2-4E92-9E3E-AB0A390BE89A",
    ...
    (
        "🙈 VIP Casais & Cornos 🙈",
        "R$14,90",
        "https://app.pushinpay.com.br/service/pay/9f5e0e91-7391-4e05-b950-2983363f9424",
    ...
    (
        "🔞 VIP Novinhas 🔞",
        "R$29,90",
        "https://app.pushinpay.com.br/service/pay/9f5e0ed0-3fe7-48f0-8480-c77f7505032d",
        "https://app.pushinpay.com.br/service/pay/9F5BF54F-87D2-4E92-9E3E-AB0A390BE89A",
...
async def cupom_escolha(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if query.data == "sem_cupom":
        ...
        await context.bot.send_message(
            chat_id=user_id,
            text=f"🧾 <b>Fez o pagamento?</b>\nReceba seu acesso enviando o comprovante aqui: @cgsuporteads",
            parse_mode="HTML"
        )
    else:
